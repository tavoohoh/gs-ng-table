(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ngx-translate/core'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/common/http'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@rappipay/gs-tables', ['exports', '@angular/core', '@ngx-translate/core', '@angular/platform-browser', '@angular/common', '@angular/common/http', '@angular/forms'], factory) :
    (global = global || self, factory((global.rappipay = global.rappipay || {}, global.rappipay['gs-tables'] = {}), global.ng.core, global.core$1, global.ng.platformBrowser, global.ng.common, global.ng.common.http, global.ng.forms));
}(this, (function (exports, core, core$1, platformBrowser, common, http, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var GsTablesService = /** @class */ (function () {
        ...
        GsTablesService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function GsTablesService_Factory() { return new GsTablesService(core.ɵɵinject(core$1.TranslateService)); }, token: GsTablesService, providedIn: "root" });
    ...
    (function (GCountryCode) {
        ...
        GCountryCode["UY"] = "uy";
        GCountryCode["VE"] = "ve";
    })(exports.GCountryCode || (exports.GCountryCode = {}));

    (function (GTypeRowEnum) {
        GTypeRowEnum["PHONE"] = "phone";
        GTypeRowEnum["CURRENCY"] = "currency";
    })(exports.GTypeRowEnum || (exports.GTypeRowEnum = {}));
    ...
    var GsTablesComponent = /** @class */ (function () {
        function GsTablesComponent(sanitizer, tableService, customStyles) {
             ...
             */
            this.rowActionClick = new core.EventEmitter();
            /**
             ...
             */
            this.navigateTo = new core.EventEmitter();
            /**
             ...
             */
            this.tableDataChanged = new core.EventEmitter();
            /**
             * Event emitted when a custom footer action is clicked
             */
            this.tableActionClick = new core.EventEmitter();
    ...
    exports.TEXT_TABLE = TEXT_TABLE;
    exports.ɵa = GsTableRowActionsComponent;
    exports.ɵb = GsAdditionalDataComponent;
    exports.ɵc = GsCheckboxComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=rappipay-gs-tables.umd.js.map
